export default function Feature () {
  return (
    <div>
      <Left/>
      <div className="absolute bg-secondary w-screen left-0">
        <Right />
      </div>
    </div>
  )
    ...
    <div className="flex justify-center items-center py-16 sm:py-30">
      <div className="md:flex flex-row-reverse">
        <div className="flex justify-center">
          <img src="/images/github.jpeg" className="w-[250px] sm:w-[400px] rounded-lg outline outline-2 outline-primary"/>
        </div>

...
selecting_prompt_config = {
    "context": "You are a database expert.\nPlease compare a list of database under specific questions and return a result JSON.",
    "example_input_variables": ["requirement", "analysis_result"],
    "example_template": """
        requirement: {requirement}
        analysis_result: {analysis_result},
    ...
    "examples": [
        {
            "requirement": "Databases: MySQL, PostgreSQL, MariaDB\nAspects:\n{\n    \"data_type\": \"Which type of data can this database store?\",\n    \"volume\": \"How suitable is this database for storing a medium set of sql data?\",\n    \"read_consistency\": \"How good is this data's read consistency\",\n    \"respond_time\": \"How good is this database response time?\",\n    \"maturity\": \"How mature is this database?\"\n}",
            "analysis_result": "[\n    {\n        \"database\": \"MySQL\",\n        \"data_type\": \"Numeric data, String data, Date and time data, Binary data, JSON data.\",\n        \"volume\": \"MySQL is very suitable for storing a medium set of SQL data. It is a fast and reliable database that can handle millions of records without any problems.\",\n        \"read_consistency\": \"MySQL read consistency is generally good, but it depends on the isolation level that you are using.\",\n        \"respond_time\": \"In general, MySQL response time is typically in the range of milliseconds to tens of milliseconds, even for complex queries or queries that involve large amounts of data. However, in some cases, response time may be slower, especially if the server is overloaded or if the queries being executed are very complex.\",\n        \"maturity\": \"MySQL is a very mature database. It was first released in 1995, and it has been under active development ever since. MySQL is one of the most popular databases in the world, and it is used by millions of websites and applications.\"\n    },\n    {\n        \"database\": \"PostgreSQL\",\n        \"data_type\": \"Numeric data, String data, Date and time data, Binary data, JSON data, Geometric data, XML data.\",\n        \"volume\": \"PostgreSQL is very suitable for storing a medium set of SQL data. It is a fast and reliable database that can handle millions of records without any problems\",\n        \"read_consistency\": \"PostgreSQL has excellent read consistency. It uses a multi-version concurrency control (MVCC) system to ensure that readers always see a consistent view of the data, even if other transactions are modifying the data at the same time.\",\n        \"respond_time\": \"PostgreSQL has very good response time, typically in the range of milliseconds to tens of milliseconds. This is because PostgreSQL is a very efficient database, and it is optimized for performance.\",\n        \"maturity\": \"PostgreSQL is a very mature database. It was first released in 1996, and it has been under active development ever since. PostgreSQL is one of the most popular databases in the world, and it is used by millions of websites and applications.\"\n    },\n    {\n        \"database\": \"MariaDB\",\n        \"data_type\": \"Numeric data, String data, Date and time data, Binary data, JSON data, Geometric data, XML data.\",\n        \"volume\": \"MariaDB is very suitable for storing a medium set of SQL data. It is a fast and reliable database that can handle millions of records without any problems.\",\n        \"read_consistency\": \"MariaDB has good read consistency. It uses a multi-version concurrency control (MVCC) system to ensure that readers always see a consistent view of the data, even if other transactions are modifying the data at the same time.\",\n        \"respond_time\": \"MariaDB has very good response time, typically in the range of milliseconds to tens of milliseconds. This is because MariaDB is a very efficient database, and it is optimized for performance.\",\n        \"maturity\": \"MariaDB is a mature and stable database. It was first released in 2009, and it has been under active development ever since. MariaDB is a fork of MySQL, and it is compatible with the MySQL ecosystem.\"\n    }\n]"
        },
        {
            "requirement": "Databases: Amazon Timestream, InfluxDB, Apache Cassandra\nAspects:\n{\n    \"data_type\": \"Which type of data can this database store?\",\n    \"volume\": \"How suitable is this database for storing a large set of time series data?\",\n    \"read_consistency\": \"How good is this data's read consistency?\",\n    \"respond_time\": \"How good is this database response time?\",\n    \"maturity\": \"How mature is this database?\"\n}",
            "analysis_result": "[\n    {\n        \"database\": \"Amazon Timestream\",\n        \"data_type\": \"Time series data, Dimensional data.\",\n        \"volume\": \"Amazon Timestream is very suitable for storing a large set of time series data. It is a fast, scalable, and cost-effective database that is specifically designed for time series data.\",\n        \"read_consistency\": \"Amazon Timestream has eventual read consistency. This means that readers may not always see the most recent changes to the data immediately after they are written. However, the data will eventually become consistent within a few seconds.\",\n        \"respond_time\": \"Amazon Timestream offers near real-time latencies for data ingestion and query response. This means that you can ingest data into Timestream and start querying it within milliseconds. Timestream's built-in memory store is optimized for rapid point-in-time queries, and the magnetic store is optimized to support fast analytical queries.\",\n        \"maturity\": \"Amazon Timestream is a relatively new database, but it is maturing rapidly. It was first released in 2019, and it has been under active development ever since. Timestream is used by a wide variety of companies, including Netflix, Tesla, Airbnb, and Amazon itself.\"\n    },\n    {\n        \"database\": \"InfluxDB\",\n        \"data_type\": \"Time series data, Dimensional data.\",\n        \"volume\": \"InfluxDB is very suitable for storing a large set of time series data. It is a fast, scalable, and cost-effective database that is specifically designed for time series data.\",\n        \"read_consistency\": \"InfluxDB has eventual read consistency. This means that readers may not always see the most recent changes to the data immediately after they are written. However, the data will eventually become consistent within a few seconds.\",\n        \"respond_time\": \"For simple queries on small datasets, InfluxDB can respond in milliseconds. For more complex queries on larger datasets, the response time may be several seconds or even minutes.\",\n        \"maturity\": \"InfluxDB is a mature and stable database. It was first released in 2013, and it has been under active development ever since. InfluxDB is used by a wide variety of companies, including Cisco, Twitter, Uber, Salesforce, and Netflix.\"\n    },\n    {\n        \"database\": \"Apache Cassandra\",\n        \"data_type\": \"Time series data, Dimensional data.\",\n        \"volume\": \"Apache Cassandra is a good choice for storing a large set of time series data. It is a distributed database that can scale horizontally to handle large amounts of data. Cassandra is also very fast and performant, making it ideal for time series data applications.\",\n        \"read_consistency\": \"Cassandra has eventual read consistency. This means that readers may not always see the most recent changes to the data immediately after they are written. However, the data will eventually become consistent within a few seconds.\",\n        \"respond_time\": \"Cassandra's response time for reads is generally very good, typically less than 10 milliseconds. For writes, the response time can be slightly higher, but it is still typically less than 100 milliseconds.\",\n        \"maturity\": \"Apache Cassandra is a mature and stable database. It was first released in 2008, and it has been under active development ever since. Cassandra is used by a wide variety of companies, including Netflix, Spotify, Airbnb, Twitter, Reddit, Uber, Lyft, and Instacart.\"\n    }\n]"
        }
    ],
}
